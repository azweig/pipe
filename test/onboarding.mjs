...
test("el backup entra en el checklist inicial, no queda para 'después'", () => {
  ...
  const r = calcularOnboarding({ backupOK: false, st: { whatsapp: { bridge: ["1"] } }, acc: { email: [{ label: "x" }] }, llm: conKeyNube })
...
test("listo=true sólo con los cuatro", () => {
  const r = calcularOnboarding({ backupOK: true, st: { whatsapp: { bridge: ["1"] } }, acc: { email: [{ label: "x" }] }, llm: conKeyNube })
