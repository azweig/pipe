...
test("seed() cubre TODAS las columnas de messages (sin drift silencioso)", () => {
  ...
  const row = { id: "X1", channel: "ch", account: "ac", thread: "th", jid: "jd", sender: "sn", name: "nm", text: "tx", ts: 12345, dir: "out", grp: "gp", media: "md", mediaType: "mt", filename: "fn", unread: 1, body: "bd", summary: "sm", attachments: "at", rev: 1, tag: "historia" }
  seed([row])
