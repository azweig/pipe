...
function renderConv() {
  ...
  const inputRow = `<div style="display:flex;gap:5px;align-items:flex-end;width:100%">
...
window.aiMenu = () => {
  openSheet(`<h2 style="margin:0 0 4px">✨ IA</h2><div class="sub" style="margin:0 0 14px">Nada de esto se envía — es solo para vos.</div>
    ...
    <button class="btn ghost" style="width:100%;text-align:left;display:flex;gap:10px;align-items:center" onclick="aiSummarizeMenu()">📝 <div><div class="b">Resumir chat</div><div class="tiny muted">Resumen guardado acá — no se envía</div></div></button>`)
}
